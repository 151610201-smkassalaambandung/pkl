...
public class doa16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doa16);
    ...
    private void play() {
        ...
        mp = MediaPlayer.create(this, R.raw.doa8);
    ...
    public void onBackPressed(){
        Intent i = new Intent(doa16.this, Doa.class);
        startActivity(i);
        mp.stop();
    }
}
