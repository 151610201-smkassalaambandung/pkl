...
public class tahyad2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tahyad2);
    ...
    private void play() {
        ...
        mp = MediaPlayer.create(this, R.raw.tahyad2);
    ...
    public void onBackPressed(){
        Intent i = new Intent(tahyad2.this, Sholat.class);
        startActivity(i);
        mp.stop();
    }
}
