...
public class Wudhu4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wudhu4);
    ...
    private void play() {
        ...
        mp = MediaPlayer.create(this, R.raw.wud);
    ...
    public void onBackPressed(){
        Intent i = new Intent(Wudhu4.this, Wudhu.class);
        startActivity(i);
        mp.stop();
    }
}
