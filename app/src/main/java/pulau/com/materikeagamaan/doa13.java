...
public class doa13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doa13);
    ...
    private void play() {
        ...
        mp = MediaPlayer.create(this, R.raw.doa3);
    ...
    public void onBackPressed(){
        Intent i = new Intent(doa13.this, Doa.class);
        startActivity(i);
        mp.stop();
    }
}
