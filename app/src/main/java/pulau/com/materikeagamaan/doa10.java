...
public class doa10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doa10);
    ...
    private void play() {
        ...
        mp = MediaPlayer.create(this, R.raw.doa4);
    ...
    public void onBackPressed(){
        Intent i = new Intent(doa10.this, Doa.class);
        startActivity(i);
        mp.stop();
    }
}
