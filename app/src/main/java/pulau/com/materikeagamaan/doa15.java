...
public class doa15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doa15);
    ...
    private void play() {
        ...
        mp = MediaPlayer.create(this, R.raw.doa7);
    ...
    public void onBackPressed(){
        Intent i = new Intent(doa15.this, Doa.class);
        startActivity(i);
        mp.stop();
    }
}
