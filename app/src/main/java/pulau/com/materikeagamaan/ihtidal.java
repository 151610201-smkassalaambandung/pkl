...
public class ihtidal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ihtidal);
    ...
    private void play() {
        ...
        mp = MediaPlayer.create(this, R.raw.ihtidal);
    ...
    public void onBackPressed(){
        Intent i = new Intent(ihtidal.this, Sholat.class);
        startActivity(i);
        mp.stop();
    }
}
