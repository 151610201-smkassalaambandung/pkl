...
public class nashr extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nashr);
    ...
    private void play() {
        ...
        mp = MediaPlayer.create(this, R.raw.nashr);
    ...
    public void onBackPressed(){
        Intent i = new Intent(nashr.this, Surat.class);
        startActivity(i);
        mp.stop();
    }
}
