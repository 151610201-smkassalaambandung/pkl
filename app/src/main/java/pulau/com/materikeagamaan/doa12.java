...
public class doa12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doa12);
    ...
    private void play() {
        ...
        mp = MediaPlayer.create(this, R.raw.doa6);
    ...
    public void onBackPressed(){
        Intent i = new Intent(doa12.this, Doa.class);
        startActivity(i);
        mp.stop();
    }
}
