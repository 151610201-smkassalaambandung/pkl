...
public class doa6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doa6);
    ...
    private void play() {
        ...
        mp = MediaPlayer.create(this, R.raw.doa2);
    ...
    public void onBackPressed(){
        Intent i = new Intent(doa6.this, Doa.class);
        startActivity(i);
        mp.stop();
    }
}
