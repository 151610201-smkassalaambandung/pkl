...
public class kaafiirun extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kaafiirun);
    ...
    private void play() {
        ...
        mp = MediaPlayer.create(this, R.raw.kafirun);
    ...
    public void onBackPressed(){
        Intent i = new Intent(kaafiirun.this, Surat.class);
        startActivity(i);
        mp.stop();
    }
}
