...
public class Aqidah3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aqidah3);
    ...
    private void play() {
        ...
        mp = MediaPlayer.create(this, R.raw.sifat);
    ...
    public void onBackPressed(){
        Intent i = new Intent(Aqidah3.this, Aqidah.class);
        startActivity(i);
        mp.stop();
    }
}
