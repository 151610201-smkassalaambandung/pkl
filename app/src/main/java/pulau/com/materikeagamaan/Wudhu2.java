...
public class Wudhu2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wudhu2);
    ...
    private void play() {
        ...
        mp = MediaPlayer.create(this, R.raw.nw);
    ...
    public void onBackPressed(){
        Intent i = new Intent(Wudhu2.this, Wudhu.class);
        startActivity(i);
        mp.stop();
    }
}
