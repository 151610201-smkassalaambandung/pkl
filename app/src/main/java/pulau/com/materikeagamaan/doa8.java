...
public class doa8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doa8);
    ...
    private void play() {
        ...
        mp = MediaPlayer.create(this, R.raw.doa5);
    ...
    public void onBackPressed(){
        Intent i = new Intent(doa8.this, Doa.class);
        startActivity(i);
        mp.stop();
    }
}
