...
public class tahyad1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tahyad1);
    ...
    private void play() {
        ...
        mp = MediaPlayer.create(this, R.raw.tahyad1);
    ...
    public void onBackPressed(){
        Intent i = new Intent(tahyad1.this, Sholat.class);
        startActivity(i);
        mp.stop();
    }
}
